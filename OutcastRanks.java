...
public final class OutcastRanks extends JavaPlugin {
    ...
    public CreateConfig config, rankData, rankWaitingList, tablist, stats, chatMessages;
    ...
    public void onEnable() {
        ...
        chatMessages = new CreateConfig("chat_messages.yml", "Outcast/Ranks");
        ...
        getServer().getScheduler().runTaskTimer(this, Tablist::displayRanks, 0, 40);
    }
